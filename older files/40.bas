...
Sub GetUserInputAndRunSubroutines()
    ...
    squadCol = InputBox("Please enter the column letter containing 'squad':", "Input needed", "E")
    
    ' Call both subroutines with the user input
    PivotData lastRow, squadCol
    PivotDataUnique lastRow, squadCol

End Sub
Sub PivotData(ByVal lastRow As Long, ByVal squadCol As String)
...
End Sub
Sub PivotDataUnique(ByVal lastRow As Long, ByVal squadCol As String)
