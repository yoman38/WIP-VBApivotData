...
For i = 1 To rng.Rows.Count
        ...
        If Not rngFilterExclude Is Nothing And filterExcludeKeyword <> "" Then
            excludeFilterValue = rngFilterExclude.Cells(i, 1).value
            filterExcludeCondition = InStr(1, CStr(excludeFilterValue), filterExcludeKeyword, vbTextCompare) = 0
        Else
