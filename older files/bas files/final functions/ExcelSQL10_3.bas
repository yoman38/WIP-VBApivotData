...
Sub GenerateSQL()
    ...
    If useFilterExclude Then
        filterExcludeKeyword = GetUserInput("Enter the keyword to skip rows.")
    ...
    For i = 1 To rng.Rows.Count
        ...
        If Not rngFilter Is Nothing And filterKeyword <> "" Then
            If i <= rngFilter.Rows.Count Then
                ...
                filterCondition = InStr(1, CStr(filterValue), filterKeyword, vbTextCompare) > 0
            Else
        ...
        If Not rngFilterExclude Is Nothing And filterExcludeKeyword <> "" Then
            If i <= rngFilterExclude.Rows.Count Then
                ...
                If IsNumeric(filterExcludeKeyword) Then
                    filterExcludeCondition = Not (IsNumeric(filterValue) And CDbl(filterValue) = CDbl(filterExcludeKeyword))
                Else
                    filterExcludeCondition = InStr(1, CStr(filterValue), filterExcludeKeyword, vbTextCompare) = 0
                End If
            Else
