    ...
    Dim guessedType As String
        ...
        If Not selectedCells Is Nothing Then
            ...
            For i = 1 To selectedCells.Cells.Count
                ...
                ' Determine the guessedType for the column
                guessedType = GuessDataType(rngHeaders.Cells(1, i).value)  ' Assuming the column headers and data are in the same order
                ' Generate the ALTER COLUMN statement first for each column
                result = result & "ALTER TABLE " & outputFileName & " ALTER COLUMN " & columnName & " " & guessedType & " NOT NULL;" & vbCrLf
