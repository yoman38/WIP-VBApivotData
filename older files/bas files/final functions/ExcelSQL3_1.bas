...
Function GetAdditionalTableDetails(rngHeaders As Range, outputFileName As String) As String
    ...
    If response = vbYes Then
        ...
        If Not selectedCells Is Nothing Then
            ...
            ' Generate the ALTER COLUMN statements to set the columns as NOT NULL first
            For i = 1 To selectedCells.Cells.Count
                result = result & "ALTER TABLE " & outputFileName & " ALTER COLUMN " & columnNames(i) & " SET NOT NULL;" & vbCrLf
            Next i
    
            ' Generate the ALTER TABLE ADD PRIMARY KEY statement
    ...
    If userResponse = vbYes Then
        ...
        If Not selectedCells Is Nothing Then
            ...
            result = result & "ALTER TABLE " & outputFileName & " ALTER COLUMN " & columnName & " SET NOT NULL;" & vbCrLf
