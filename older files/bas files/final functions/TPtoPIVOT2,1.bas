...
Sub GetUserInputAndRunSubroutines()
    ...
    For Each ws In srcWorkbook.Sheets
        ...
        wsNames(i) = i & ". " & ws.Name
    Next ws
    wsNum = InputBox("Please enter the number of the worksheet you want to use as the source:" & vbNewLine & _
    ...
    Set lastRowRange = Application.InputBox("Please click on the last row of the table:", Type:=8, Default:=ActiveSheet.Cells(ActiveSheet.Rows.Count, 1).Address)
    On Error GoTo 0
