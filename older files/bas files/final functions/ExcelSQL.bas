...
Sub GenerateSQL()
    ...
    Set wb = Workbooks.Open(gSelectedExcelFile)
...
Function SelectFile() As String
    ' Use the global variable set in TPtoPIVOT.bas
...
Function SelectFolder() As String
    ...
    With Application.FileDialog(msoFileDialogFolderPicker)
        ...
        If .Show = -1 Then
            ...
            SelectFolder = .SelectedItems(1) & "\" & outputFileName & ".txt"
            gOutputFilePath = SelectFolder
 'Here you can change the extension
        Else
...
Function OpenWorkbook(filePath As String) As Workbook
        Set OpenWorkbook = Workbooks.Open(gSelectedExcelFile) ' Use the global variable set in TPtoPIVOT.bas
End Function
