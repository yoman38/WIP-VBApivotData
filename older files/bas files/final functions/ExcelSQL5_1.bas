        ...
        If response = vbYes Then
            ...
            If Not selectedCells Is Nothing Then
                ...
                For i = 1 To selectedCells.Cells.Count
                    ...
                    result = result & "ALTER TABLE " & outputFileName & " ALTER COLUMN " & columnNames(i) & " NOT NULL;" & vbCrLf
                    MsgBox columnNames(i) & " has been set to NOT NULL constraint.", vbInformation, "Information"
                Next i
