...
Sub GenerateSQL()
    ...
    ' Ask if the user wants to use filtering keyword
    ...
    End If
        ...
        ' Ask the user if they want to skip rows containing specific keywords
    Dim skipKeywords As Boolean
    Dim keywords As Variant
    skipKeywords = MsgBox("Do you want to skip rows if they contain a given keyword?", vbYesNo) = vbYes
    If skipKeywords Then
        keywords = Split(InputBox("Provide the keywords separated by commas (e.g., 'keyword1,keyword2'):"), ",")
    End If
