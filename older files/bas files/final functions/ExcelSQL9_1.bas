...
Function GenerateInsertStatements(rng As Range, filterKeyword As String, outputFileName As String, Optional filterRange As Range, Optional duplicateCheckRange As Range, Optional emptyCheckRange As Range, Optional filterExcludeKeyword As String = "", Optional filterExcludeRange As Range) As String
    ...
    For i = 1 To rng.Rows.Count
        ...
        If filterExcludeKeyword = "" Then
            filterExcludeCondition = True
        Else
            filterExcludeCondition = InStr(1, filterExcludeRange.Cells(i, 1).value, filterExcludeKeyword, vbTextCompare) = 0
        End If
